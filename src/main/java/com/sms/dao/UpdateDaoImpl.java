...
public class UpdateDaoImpl implements UpdateDao{
	...
	public void updateProd(Product product) {
		...
		jdbcTemplate.update(sql, new Object[] {product.getProductName(),product.getProductCategory(),product.getProductQuantity(),product.getProductCostPrice(),product.getProductSellingPrice()});
	}
